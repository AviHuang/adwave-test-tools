"""
P1 Functional Test: Upload Display Creative
"""
import pytest
...
@pytest.mark.asyncio
async def test_upload_display_creative(browser_agent, config):
    """Test uploading a Display format creative."""
    result = await browser_agent.create_creative(ad_format="Display")
    ...
    if not upload_success:
        assert False, (
            f"Display creative upload failed. "
